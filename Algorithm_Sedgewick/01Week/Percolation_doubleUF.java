...
public class Percolation_doubleUF {
    // 1. Be careful Input data: (1, 1) ~ (n, n)
    // 2. Wrong Input -> throw IllegalArgumentException

    private final int gridSize; // n, not n*n
    private boolean[][] grid; // 000: close, 100: open, 110: open and connected to top, 101: open and connected bottom 
    ...
    public Percolation_doubleUF(int n) {
        if (n <= 0)
