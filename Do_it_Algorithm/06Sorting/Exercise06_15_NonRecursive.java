...
class Exercise06_15_NonRecursive {
	// Q15 피벗 선택하기의 방법 2을 사용하여 Q13의 메서드를 수정하세요
	...
	static void quickSort(int[] a, int left, int right) {
		...
		while (lstack.isEmpty() != true) {
			...
			if (right - left + 1 > 3) {
				int minIdx = min_idx(a, pl, pr, pc);
				int medIdx = med_idx(a, pl, pr, pc);
				int maxIdx = max_idx(a, pl, pr, pc);
